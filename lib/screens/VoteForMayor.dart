...
class votefor_mayor extends StatefulWidget {
  const votefor_mayor({super.key});

  @override
  State<votefor_mayor> createState() => _votefor_mayorState();
}

class _votefor_mayorState extends State<votefor_mayor> {
  @override
