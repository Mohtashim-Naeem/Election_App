...
class VoteToPresident extends StatefulWidget {
  const VoteToPresident({super.key});

  @override
  State<VoteToPresident> createState() => _VoteToPresidentState();
}

class _VoteToPresidentState extends State<VoteToPresident> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                height: height * 0.469, //It's mean 46.9% of height
                child: GridView(
                  ...
                  children: [
                    ClipRRect(
                      // I give "borderRadius.only" because we can change any side's border
