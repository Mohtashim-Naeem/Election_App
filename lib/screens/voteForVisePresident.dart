...
class VoteForPresident extends StatefulWidget {
  const VoteForPresident({super.key});

  @override
  State<VoteForPresident> createState() => _VoteForPresidentState();
}

class _VoteForPresidentState extends State<VoteForPresident> {
  @override
                      ...
                      ClipRRect(
                        ...
                        child: Stack(fit: StackFit.expand, children: [
                          Container(
                            ...
                            child: Opacity(
                              opacity: 0.5,
                              child: Image.asset('assets/images/face5.jpg',
                                  fit: BoxFit.cover),
                            ),
                          ),
                          // Align(
                        ...
                        child: Stack(fit: StackFit.expand, children: [
                          Container(
                            ...
                            child: Opacity(
                              ...
                              opacity: 0.5,
                              child: Image.asset('assets/images/face7.jpg',
                                  fit: BoxFit.cover),
                            ),
                          ),
                          // Align(
